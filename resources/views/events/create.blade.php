...
$end_date = $_POST['end_date'];
    ...
    $sql = "INSERT INTO `bookings` ( `title`, `month`, `day`, `start_date`, `end_date`) VALUES
    ( '$title', '$month', '$day', '$start_date', '$end_date')";
    $run_cat=mysqli_query($conn,$sql);
    if(isset($run_cat)){
             echo '<meta http-equiv="refresh" content=2"; url=\'dashbord.php\'" />';
    }
}
...
$end_date = $_POST['end_date'];
    ...
    $sql = "update `bookings` set  title='$title', month='$month', day='$day', start_date='$start_date',
...
<body class="bg-light">
 <div class="container py-5" id="page-container">
     ...
     <?php
        ...
        ?>
       <td>
        <a name="" id="" class="btn btn-success btn-sm" href="{{ route('events.edit', $event->id)}}" role="button" >Edit</a>
        <a name="" id="" class="btn btn-danger btn-sm" href="{{ route('events.edit', $event->id) }}" role="button" >Delete</a>
    </td>
                 ...
                 <div class="form-group mb-2">
                    ...
                    <div class="card-footer">
                        <div class="text-center">
                            ...
                            <button class="btn btn-primary btn-sm rounded-0" type="submit" name="submit" form="schedule-form"><i class="fa fa-save"></i> Edite</button>
